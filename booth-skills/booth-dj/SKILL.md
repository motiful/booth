...
2. Act on findings:
   ...
   - Pending tasks to dispatch? → Spin decks
   - Stuck decks (>20 min)? → Spin review deck or escalate
3. Nothing to act on → stay quiet, don't waste tokens
...
- **Pipeline, not batch** — maintain 3+ concurrent decks. When one completes, spin the next.
